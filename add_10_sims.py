...
quests_config = {
    "quest_01_holiday_kickoff": {
        "num": "01",
        "concept": "Vocabulary",
        "engines": ["MORPH_GAME", "GARDEN_GUARD", "SENTENCE_BLOCKS", "WORDGRID_ENGINE"]
    },
    "quest_02_going_to_mastery": {
        "num": "02",
        "concept": "Be Going To Future",
        "engines": ["MORPH_GAME", "GARDEN_GUARD", "SENTENCE_BLOCKS", "WORDGRID_ENGINE"]
    },
    "quest_03_question_tags_mastery": {
        "num": "03",
        "concept": "Question Tags",
        "engines": ["MORPH_GAME", "GARDEN_GUARD", "SENTENCE_BLOCKS", "WORDGRID_ENGINE"]
    },
    "quest_04_reported_speech_mastery": {
        "num": "04",
        "concept": "Reported Speech",
        "engines": ["MORPH_GAME", "GARDEN_GUARD", "SENTENCE_BLOCKS", "WORDGRID_ENGINE"]
    },
    "quest_07_past_regrets": {
        "num": "07",
        "concept": "Third Conditional",
        "engines": ["MORPH_GAME", "GARDEN_GUARD", "SENTENCE_BLOCKS", "WORDGRID_ENGINE"]
    },
    "quest_08_voice_mastery": {
        "num": "08",
...
# Find current max SIM file for each quest and add 10 more
...
print("\n✅ All 10 additional SIM files added to each quest (01-04, 07-09)!")
